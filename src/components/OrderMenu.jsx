    ...
    <section id="menu" className="bg-[hsl(var(--parchment))] py-16 md:py-24">
      <div className="max-w-6xl mx-auto px-6 md:px-10">
        <div className="text-center mb-10 md:mb-14">
          ...
          <h2 className="font-heading text-3xl md:text-4xl text-balance">クリームロール</h2>
          <p className="mt-4 text-sm text-foreground/60">一つ一つ職人が丁寧に巻き上げました。お好きな味をお選びください。</p>
        </div>

        {creamRolls.length === 0 ? (
          <p className="text-center text-sm text-foreground/50 py-12">準備中です。少々お待ちください。</p>
        ) : (
